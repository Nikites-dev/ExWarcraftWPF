            ...
            else if (menuItem.Header.ToString() == "Load local")
            {
                ...
                if (openFileDialog.ShowDialog() == true)
                {
                    ...
                    using (StreamReader reader = new StreamReader(fileInfo.Open(FileMode.Open, FileAccess.Read)))
                    {
                        ...
                        hero.CurrentStrensth = int.Parse(unitInfo[1]);
                        hero.CurrentDesterity = int.Parse(unitInfo[2]);
                        hero.CurrentConstitution = int.Parse(unitInfo[3]);
                        hero.CurrentIntellisense = int.Parse(unitInfo[4]);
